...
"   * g:airline#themes#darcula#palette.normal 
"       * the colors for a statusline while in normal mode
"   * g:airline#themes#darcula#palette.normal_modified 
"       * the colors for a statusline while in normal mode when the buffer has
"         been modified
"   * g:airline#themes#darcula#palette.visual 
...
" let g:airline#themes#darcula#palette.normal = airline#themes#generate_color_map(
...
" let g:airline#themes#darcula#palette.normal = {
...
" applied after g:airline#themes#darcula#palette.normal, hence why only certain keys a re
" declared.
...
let s:airline_b_insert   = [ darcula#palette.statusLineFg[0], darcula#palette.foldedBg[0],
                           \ darcula#palette.statusLineFg[1], darcula#palette.foldedBg[1] ]
let s:airline_c_insert   = [ darcula#palette.statusLineFg[0], darcula#palette.statusLine[0],
                           \ darcula#palette.statusLineFg[1], darcula#palette.statusLine[1], 'NONE']
